    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 bg-gradient-to-br from-rose-900 via-rose-800 to-rose-700 text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">Our Fragrances</h1>
          <p className="text-xl text-rose-100 max-w-2xl mx-auto">
            Discover our curated collection of premium fragrances from around the world. Each scent tells a unique story
